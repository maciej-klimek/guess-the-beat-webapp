...
const PlaylistSelection: React.FC<PlaylistSelectionProps> = ({ accessToken }) => {
    ...
    const [playlists, setPlaylists] = useState<Playlist[]>([
        ...
        { id: "pop", name: "Pop Hits", url: "https://api.spotify.com/v1/playlists/37i9dQZF1DX4v0Y84QklHD" },
        { id: "rap", name: "Rap Classics", url: "https://api.spotify.com/v1/playlists/37i9dQZF1DXbkfWVLd8wE3" }, 
        { id: "rock_pl", name: "Polski Rock", url: "https://api.spotify.com/v1/playlists/1UZuFEO1iIad6ys4S9Teor" },
        { id: "10s", name: "All out of 2010s", url: "https://api.spotify.com/v1/playlists/37i9dQZF1DX5Ejj0EkURtP" },
        { id: "hits_pl", name: "Poskie Przeboje Wszechczasów", url: "https://api.spotify.com/v1/playlists/37i9dQZF1DX8J2l55TrZk6" }, 
        { id: "00_metal_classics", name: "00s Metal Classics", url: "https://api.spotify.com/v1/playlists/37i9dQZF1DWXNFSTtym834" },
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center text-green-500 text-center bg-gray1 poppins-semibold p-4">
            ...
            <h5 className="text-xl text-neutral-800 md:text-1xl mt-6 mb-4">To guess albums from</h5>
